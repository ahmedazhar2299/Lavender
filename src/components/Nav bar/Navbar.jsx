...
export default function Navbar() {
  return (
    ...
    <div style={{"background-color":"#EEECDF"}} className='flex pb-5 lg:px-10 md:px-0 md:justify-between vsm:flex-col md:flex-row vsm:justify-center vsm:items-center'>
      ...
      <i className="fa-solid fa-user mx-3 cursor-pointer hover:opacity-60"></i>
      <i className="fa-solid fa-cart-shopping mr-3 relative cursor-pointer hover:opacity-60">
