...
export default function Category() {
  ...
  return (
    <div style={{"backgroundColor":"#F8F9FA"}} className='flex w-full lg:py-5 md:px-20 md:py-5 lg:px-60 vsm:flex-col lg:flex-row justify-center items-center'>
      <div onClick={()=>navigate('/category/women')} className='lg:mr-5 lg:mb-0 vsm:mr-0 vsm:mb-5 hover:opacity-75 overflow-hidden lg:w-4/12 vsm:w-6/12'>
      ...
      <div onClick={()=>navigate('/category/men')} className='lg:mr-5 lg:mb-0 vsm:mr-0 vsm:mb-5 hover:opacity-75 overflow-hidden lg:w-4/12 vsm:w-6/12'>
